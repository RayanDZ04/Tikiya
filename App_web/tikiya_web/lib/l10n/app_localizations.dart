...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'fr': {
      ...
      'hint_first_name': 'Votre prénom',
      'hint_last_name': 'Votre nom',
    ...
    'ar': {
      ...
      'home_phone_semantics': 'معاينة تطبيق الهاتف',
        ...
        'seo_orga_title': 'تكية! برو – حلول التذاكر للمنظمين في الجزائر | وصول تجريبي',
        'seo_orga_description':
          'انضم إلى الشركاء المؤسسين في تكية! برو. إدارة فعاليات وتذاكر وأدوات احترافية بإطلاق تدريجي.',
      ...
      'orga_public_title': 'تكية! برو قادمة\nكن شريكًا مؤسسًا',
      'orga_public_subtitle':

...
// ── Manage card with delete button ─────────────────────────────────────────────
class _EventManageCard extends StatelessWidget {
  const _EventManageCard({required this.event, required this.onDelete});
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                IconButton(
                  icon: Icon(Icons.delete_outline, color: bleuProfond.withValues(alpha: 0.5)),
                  onPressed: onDelete,
                ),
              ],
            ),
